...
import edu.ntnu.idatt2105.trivium.validation.impl.CoAuthorListValidator;
 ...
 */
@Documented
@Constraint(validatedBy = CoAuthorListValidator.class)
@Target({ElementType.METHOD, ElementType.FIELD, ElementType.PARAMETER, ElementType.TYPE_USE})
@Retention(RetentionPolicy.RUNTIME)
public @interface CoAuthorList {
   ...
   */
  String message() default "Invalid co-author list";
