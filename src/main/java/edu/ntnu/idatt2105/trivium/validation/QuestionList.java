...
import edu.ntnu.idatt2105.trivium.validation.impl.QuestionListValidator;
...
/**
 * Annotation for validating question lists.
 ...
 */
@Documented
@Constraint(validatedBy = QuestionListValidator.class)
...
public @interface QuestionList {
   ...
   */
  String message() default "Invalid question list";
